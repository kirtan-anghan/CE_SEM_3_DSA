...
void student_detail()
{
    ...
    printf("Write a program to implement following operations on the doubly linked list.(a) Insert a node at the front of the linked list. (b) Insert a node at the end"
    "of the linked list.(c) Delete the last node of the linked list.(d) Delete a node before a specified position.\n");   //Aim of practical
